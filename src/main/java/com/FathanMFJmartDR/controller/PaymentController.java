...
public class PaymentController implements BasicGetController<Payment> {
    public static final long DELIVERED_LIMIT_MS = 300;
    public static final long ON_DELIVERY_LIMIT_MS = 300;
    public static final long ON_PROGRESS_LIMIT_MS = 300;
    public static final long WAITING_CONF_LIMIT_MS = 300;
            ...
            )
    {
        ...
        payment.history.add(new Payment.Record(Invoice.Status.WAITING_CONFIRMATION, "Menunggu pesanan"));
